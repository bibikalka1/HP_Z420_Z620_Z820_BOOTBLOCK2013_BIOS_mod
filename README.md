...
These are modded BIOS versions, fully tested for Z620 already (J61), still need Z820 testing of the respective J63 versions. Overclocking is not usually not an option when 2 cpus are used in Z820, so probably just use 3.96 or 3.96+ versions:
